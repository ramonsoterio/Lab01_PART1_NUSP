...
## 📍 Origem dos Dados
Os dados são extraídos do Brazilian E-Commerce Public Dataset by Olist no Kaggle. O dataset contém informações reais de 100 mil pedidos de 2016 a 2018.
...
2. Transformação (transform.py): * Converte CSV para Parquet (colunar e otimizado).
...
3. Relatório (report.py): Gera visualizações automáticas e um documento Markdown com a saúde dos dados.
